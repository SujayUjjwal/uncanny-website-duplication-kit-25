...
import { BarChart3, Home, Settings, Users, Phone, Bookmark, FileText, UserPlus, MessageSquare, TrendingUp } from 'lucide-react';
import AdminHeader from '@/components/admin/AdminHeader';
import DashboardStats from '@/components/admin/DashboardStats';
import QuickActions from '@/components/admin/QuickActions';
import ProTips from '@/components/admin/ProTips';
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminHeader onExport={handleExport} onImport={handleImport} />
