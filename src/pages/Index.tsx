...
const Index = () => {
  ...
  const team = [
    { name: "Kiran Shah", title: "Director", image: "/lovable-uploads/ab2cb6d5-bf7e-467e-8cef-dfaf2945b20a.png" },
    { name: "Sumit Sir", title: "PHYSICS TEACHER", image: "/lovable-uploads/ab2cb6d5-bf7e-467e-8cef-dfaf2945b20a.png" },
    { name: "Prakash Sir", title: "BIOLOGY", image: "/lovable-uploads/ab2cb6d5-bf7e-467e-8cef-dfaf2945b20a.png" },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gray-900">
        <div 
          ...
          style={{
            backgroundImage: "url('/lovable-uploads/ab2cb6d5-bf7e-467e-8cef-dfaf2945b20a.png')",
          }}
        />
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <div className="flex items-center justify-center mb-8">
            <div className="h-1 w-12 bg-yellow-500 mr-4" />
            <span className="text-yellow-500 font-semibold">A COACHING FOR EXCELLENCE</span>
            <div className="h-1 w-12 bg-yellow-500 ml-4" />
          </div>
