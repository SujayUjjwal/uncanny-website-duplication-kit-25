...
const Contact = () => {
  ...
  const contactInfo = [{
    Icon: Phone,
    text: "+91-91597730898",
    action: () => window.open('tel:+919159773089')
  }, {
    Icon: Mail,
    text: "sumitneetbooking@gmail.com",
    action: () => window.open('mailto:sumitneetbooking@gmail.com')
  }, {
    Icon: MapPin,
    text: "www.sumitneetcoaching@gmail.com",
    action: () => window.open('mailto:sumitneetcoaching@gmail.com')
  }, {
    Icon: Mail,
    text: "www.joharinform@gmail.com",
    action: () => window.open('mailto:joharinform@gmail.com')
  }];
        ...
        <div className="grid lg:grid-cols-2 gap-12" ref={contentRef}>
          ...
          <div className={`transition-all duration-700 ${contentVisible ? 'animate-gentle-slide-in-left' : 'opacity-0 -translate-x-8'}`}>
            ...
            <div className="space-y-4">
              ...
              text,
              action
            }, index) => <button key={index} onClick={action} className={`flex items-center space-x-3 group transition-all duration-500 w-full text-left ${contentVisible ? 'animate-gentle-fade-in-up' : 'opacity-0'}`} style={{
